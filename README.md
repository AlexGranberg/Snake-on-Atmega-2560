...
This project assumes the use of an AVR microcontroller, an LED matrix controlled by the MAX7219 driver, a joystick for user 
input, and a UART module for serial communication.
