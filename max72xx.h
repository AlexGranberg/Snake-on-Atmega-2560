...
#define MAX7219_CS      PB4 // CS,  pin 4 on the MAX7219 Board
#define MAX7219_DIN     PB5 // DIN, pin 3 on the MAX7219 Board
#define MAX7219_CLK     PB7 // CLK, pin 5 on the MAX7219 Board
...
#define MAX7219_SEG_NUM 4 // The number of the segments.
